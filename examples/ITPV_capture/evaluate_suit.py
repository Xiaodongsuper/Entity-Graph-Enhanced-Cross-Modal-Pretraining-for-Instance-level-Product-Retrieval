...
def compute_ar(rank_list,GT_labels,gallery_label_ids,gallery_id_label,N):
    ...
    # print("rank_list label: ",[gallery_id_label[each] for each in rank_list])
    ...
    # print("label_expect_count: ",label_expect_count)
    ...
    # print("label_retrieval_count: ",label_retrieval_count)
    # print("label_expect_count: ",label_expect_count)
...
def main():
    ...
    dev_query_suit_id_label_txt=open("{}/dev_query_suit_id_label.txt".format(args.GT_dir)).readlines()
        ...
        for topk in topk_list:
            ...
            for index,each in enumerate(retrieval_results):
                ...
                try:
                    ...
                    # hit rate
                    query_suit_label_set = set(test_query_suit_id_label[query_id]["label"])
