...
if __name__ == '__main__':
    ...
    for each_feature_type in feature_type:
        ...
        # new
        gallery_ids = read_pickle("{}/id.p".format(gallery_dir))
        gallery_ids = np.hstack(gallery_ids)

        query_ids = read_pickle("{}/id.p".format(query_dir))
        query_ids = np.hstack(query_ids)

        gallery_feature_np = read_pickle("{}/{}_feature_np.p".format(gallery_dir, each_feature_type))
        print(gallery_feature_np.shape)

        query_feature_np = read_pickle("{}/{}_feature_np.p".format(query_dir, each_feature_type))
