...
def parse_args():
    ...
    parser.add_argument("--vil",action="store_true")
...
if __name__ == '__main__':
    ...
    if args.vil: feature_type.append("vil")
    ...
    for each_feature_type in feature_type:
        ...
        # new
        gallery_ids = np.load("{}/id.p".format(gallery_dir), allow_pickle=True)
        gallery_ids = np.hstack(gallery_ids)

        query_ids = np.load("{}/id.p".format(query_dir), allow_pickle=True)
        query_ids = np.hstack(query_ids)

        gallery_feature_np = np.load("{}/{}_feature_np.p".format(gallery_dir, each_feature_type), allow_pickle=True)
        print(gallery_feature_np.shape)

        query_feature_np = np.load("{}/{}_feature_np.p".format(query_dir, each_feature_type), allow_pickle=True)
