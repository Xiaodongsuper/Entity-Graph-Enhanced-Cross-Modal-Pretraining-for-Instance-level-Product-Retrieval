...
def main():
    ...
    v_feature_list=[]
    vil_feature_list=[]
    model.load_state_dict(torch.load('../ITPV_capture/save/15w_text_you_focus_fixed_test_normlize_training/pytorch_model_4.bin')) #'./save/15w_text_you_focus_fixed_test_normlize_training/pytorch_model_4.bin')) #15w_no_graph_text_you
    model.cuda()
    model.eval()
    with torch.no_grad():
        i = 0
